https://jsk-enshu.github.io/robot-programming/robot-programming-1-2025.html
...
# terminal 2
cd ~/ros_ws/src/rcb4/ros/kxr_controller/scripts
source ~/kxr/bin/activate
source ~/ros_ws/devel/setup.bash
ipython -i -- swing.py


# terminal3 set arms' positions
source ~/kxr/bin/activate
source ~/ros_ws/devel/setup.bash
cd ~/ros_ws/src/rcb4/ros/kxr_controller/scripts
ipython -i -- interface.py --viewer pyrender

robot_model

#robot_model.rarm_joint0.joint_angle(0.1)
ri.angle_vector(robot_model.angle_vector(), 1)

a = ri.angle_vector()
robot_model.angle_vector(a)
ri.angle_vector(robot_model.angle_vector(), 4)
